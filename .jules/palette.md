...
## 2024-05-18 - Missing aria-label on dynamically generated file inputs
**Learning:** File inputs dynamically generated by AlpineJS in site builder widgets were missing accessible names, and similarly, a plus icon button lacked an aria-label.
**Action:** When evaluating forms built with AlpineJS components, ensure generated inputs and icon-only buttons include descriptive `aria-label`s.
