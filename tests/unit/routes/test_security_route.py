...
async def test_security_ban_ip(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_fail2ban.get_admin",
        mock_get_admin,
    )
    monkeypatch.setattr(
        "pit_panel.web.routes.security_malware.get_admin",
        mock_get_admin,
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security.ban_ip_address",
        mock_ban_ip_address,
    )
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security._render_security_page",
        mock_render,
    )
...
async def test_security_unban(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security.unban_ip_address",
        mock_unban_ip_address,
    )
...
async def test_security_blocklist_import(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        ...
        mock_fetch_blocklist,
    )

    mock_ban_ips_bulk = AsyncMock()
    mock_ban_ips_bulk.return_value = 1
    monkeypatch.setattr(
        "pit_panel.web.routes.security_blocklist.ban_ips_bulk",
        mock_ban_ips_bulk,
    )
...
async def test_abuseipdb_blacklist_no_key(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_abuseipdb.get_settings",
...
async def test_abuseipdb_blacklist_with_data(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_abuseipdb._abuseipdb_blacklist",
        mock_blacklist,
    )
...
async def test_abuseipdb_check(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_abuseipdb._abuseipdb_check",
        mock_check,
    )
...
async def test_security_firewall_enable(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_firewall._enable_ufw",
        mock_enable,
    )
...
async def test_security_firewall_disable(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_firewall._disable_ufw",
        mock_disable,
    )
...
async def test_security_firewall_rule_add(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_firewall._add_ufw_rule",
        mock_add,
    )
...
async def test_security_firewall_rule_delete(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_firewall._delete_ufw_rule",
        mock_delete,
    )
    monkeypatch.setattr(
        "pit_panel.web.routes.security_firewall._get_client_ip",
        lambda r: "1.2.3.4",
    )
    monkeypatch.setattr(
...
async def test_security_fail2ban_config(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_fail2ban._save_jail_config",
        mock_save,
    )
...
async def test_security_lynis_audit(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_lynis.run_lynis_audit",
        mock_audit,
    )
...
async def test_security_fail2ban_get_config(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "pit_panel.web.routes.security_fail2ban._get_jail_config",
        mock_get,
    )
