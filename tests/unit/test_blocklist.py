...
from pit_panel.core.blocklist import fetch_blocklist, daily_blocklist_import, _BLOCKLIST_CACHE, CACHE_TTL
...
async def test_daily_blocklist_import(monkeypatch):
    ...
    monkeypatch.setattr("pit_panel.core.blocklist.get_sessionmaker", lambda: lambda: MockDbSession())
