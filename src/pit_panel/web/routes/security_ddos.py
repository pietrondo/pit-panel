...
_IPTABLES_RULES: list[list[str]] = [
    ["-N", DDOS_CHAIN],
    ["-A", DDOS_CHAIN, "-p", "tcp", "--syn", "-m", "limit", "--limit", "2/s", "--limit-burst", "5", "-j", "RETURN"],  # noqa: E501
    ...
    ["-A", DDOS_CHAIN, "-p", "icmp", "--icmp-type", "echo-request", "-m", "limit", "--limit", "1/s", "--limit-burst", "4", "-j", "RETURN"],  # noqa: E501
    ["-A", DDOS_CHAIN, "-p", "icmp", "--icmp-type", "echo-request", "-j", "DROP"],
    ["-A", DDOS_CHAIN, "-p", "tcp", "--dport", "80", "-m", "connlimit", "--connlimit-above", "30", "--connlimit-mask", "32", "-j", "DROP"],  # noqa: E501
    ["-A", DDOS_CHAIN, "-p", "tcp", "--dport", "443", "-m", "connlimit", "--connlimit-above", "30", "--connlimit-mask", "32", "-j", "DROP"],  # noqa: E501
    ["-A", DDOS_CHAIN, "-p", "tcp", "--dport", "80", "-m", "recent", "--set", "--name", "HTTP_FLOOD"],  # noqa: E501
    ["-A", DDOS_CHAIN, "-p", "tcp", "--dport", "80", "-m", "recent", "--update", "--seconds", "10", "--hitcount", "50", "--name", "HTTP_FLOOD", "-j", "DROP"],  # noqa: E501
    ["-A", DDOS_CHAIN, "-p", "tcp", "--dport", "443", "-m", "recent", "--set", "--name", "HTTPS_FLOOD"],  # noqa: E501
    ["-A", DDOS_CHAIN, "-p", "tcp", "--dport", "443", "-m", "recent", "--update", "--seconds", "10", "--hitcount", "50", "--name", "HTTPS_FLOOD", "-j", "DROP"],  # noqa: E501
